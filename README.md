...
SuperLogin is a full-featured NodeJS/Express user authentication solution for APIs and Single Page Apps (SPA) using CouchDB or Cloudant. This repo contain group of users having same database function.
...
```js
app.get("/admin", superlogin.requireAuth, superlogin.requireRole("admin"), function (req, res) {
